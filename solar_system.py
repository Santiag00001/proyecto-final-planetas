from dominio.star import Star
from dominio.planet import Planet
from dominio.asteroid import Asteroid
import pygame
...
sun = Star(image_path="sol.png", mass= 2000, nucleo_status= "Activate")
mercury = Planet(image_path="mercurio.png", distance= 100, orbit_speed= 2, mass= 50, nucleo_status="Inactive")
mars = Planet(image_path="marte.png", distance= 180, orbit_speed=2, mass=250, nucleo_status="Activate")
